...
\title[Modern Software Development Practices]{Version Control} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\begin{frame}
    ...
    \begin{figure}
        \includegraphics[width=\textwidth]{images/phdcomic-vc.png}
    \end{figure}
\end{frame}
